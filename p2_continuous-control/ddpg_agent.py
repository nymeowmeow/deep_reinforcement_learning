...
class Agent():
    ...
    def __init__(self, config):
        ...
        self.critic_local = Critic(self.state_size, self.action_size, self.random_seed).to(self.device)
        self.critic_target = Critic(self.state_size, self.action_size, self.random_seed).to(self.device)
        ...
        # Replay memory
        self.memory = ReplayBuffer(self.action_size, self.buffer_size, self.batch_size, self.random_seed, self.device)
